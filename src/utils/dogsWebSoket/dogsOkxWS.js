...
import { setDogsOkxPrice } from '../../redux/dogsPricesSlice';

const useDogsOKXWebSocket = () => {
  ...
  const { sendJsonMessage, lastJsonMessage } = useWebSocket(socketUrl, {
    ...
    onMessage: () => {
      ...
      if (
        ...
        dispatch(setDogsOkxPrice({ lastPrice, open24h }));
      }
    },
...
export default useDogsOKXWebSocket;
